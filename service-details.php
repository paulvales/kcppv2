...
<html lang="en">
	<head>
		...
		<title>Bizco || Responsive html5 Business template</title>
			...
			<header class="theme-menu-two">
				<div class="top-header">
					<div class="container">
						...
						<a href="#" class="float-right p-bg-color">GET A QUOTE</a>
					</div> <!-- /.container -->
				</div> <!-- /.top-header -->
				...
				<div class="details-page-wrapper clearfix">
					...
					<div class="details-page-sidebar float-right">
						...
						<div class="sidebar-slider">
							<div id="sidebar-carousel" class="carousel slide" data-ride="carousel" data-interval="5000">
								<!-- Wrapper for slides -->
								<div class="carousel-inner" role="listbox">
								    <div class="item active">
								    	<div class="name">
								      	...
								      	<p>Leverage agile framework to the provide a robust synoce for high level overviews.</p>
								    </div>	
								    <div class="item">
									    <div class="name">
								    		<img src="images/inner-page/6.jpg" alt="Image">
								...
								<ol class="carousel-indicators">
								    <li data-target="#sidebar-carousel" data-slide-to="0" class="active"></li>
								    <li data-target="#sidebar-carousel" data-slide-to="1"></li>
								    <li data-target="#sidebar-carousel" data-slide-to="2"></li>
								</ol>		
			...
			<footer>
				<div class="container">
					...
					<div class="bottom-footer clearfix">
						...
						<p class="float-left">All Right Reserved 2017 &copy; <a href="http://themeforest.net/user/creativegigs/portfolio" target="_blank" class="tran3s">CreativeGigs</a></p>
					</div> <!-- /.bottom-footer -->
				</div> <!-- /.container -->
			</footer>
